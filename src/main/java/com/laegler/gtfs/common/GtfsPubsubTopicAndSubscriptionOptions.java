...
public interface GtfsPubsubTopicAndSubscriptionOptions extends GtfsPubsubTopicOptions {
  ...
  class PubsubSubscriptionFactory implements DefaultValueFactory<String> {
    public String create(PipelineOptions options) {
      return "projects/" + options.as(GcpOptions.class).getProject() + "/subscriptions/"
          + options.getJobName();
    }
  }
